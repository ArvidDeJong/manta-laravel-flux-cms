            ...
            <flux:card title="E-mail verificatie" color="primary">
                ...
                <div class="space-y-6">
                    <div class="text-sm text-gray-600 leading-relaxed">
                        <p class="mb-4">Bedankt voor je registratie! Voordat je verder gaat, controleer je e-mail voor een verificatielink.</p>
                    ...
                    <div class="mt-4">
                        <flux:button wire:click="resendVerification" wire:loading.attr="disabled" color="primary" block>
                            <div wire:loading wire:target="resendVerification" class="mr-2">
                                <x-flux::icon icon="arrow-path" class="animate-spin h-4 w-4" />
                            </div>
