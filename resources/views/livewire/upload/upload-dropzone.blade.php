<flux:main container>
    <div x-cloak x-data="dropzone({
        ...
        <div
            class="flex flex-col items-start justify-center w-full h-full bg-transparent dark:border-gray-600 dark:hover:border-gray-500">
            @if (!is_null($error))
                <div class="w-full p-4 mb-4 rounded dark:bg-red-600 bg-red-50">
            ...
            <div @click="$refs.input.click()"
                class="w-full border border-gray-500 border-dashed rounded cursor-pointer">
                <div>
                    <div x-show="!isDragging"
                        class="flex items-center justify-center h-full gap-3 py-8 dark:bg-gray-700 bg-gray-50">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                            class="w-4 h-4 text-gray-500 dark:text-gray-400 md:h-6 md:w-6">
                            <path
                                d="M9.25 13.25a.75.75 0 001.5 0V4.636l2.955 3.129a.75.75 0 001.09-1.03l-4.25-4.5a.75.75 0 00-1.09 0l-4.25 4.5a.75.75 0 101.09 1.03L9.25 4.636v8.614z" />
                            <path
                                d="M3.5 12.75a.75.75 0 00-1.5 0v2.5A2.75 2.75 0 004.75 18h10.5A2.75 2.75 0 0018 15.25v-2.5a.75.75 0 00-1.5 0v2.5c0 .69-.56 1.25-1.25 1.25H4.75c-.69 0-1.25-.56-1.25-1.25v-2.5z" />
                        </svg>
                        <p class="text-sm text-gray-600 dark:text-gray-400 md:text-base">Drop here or <span
                                class="font-semibold text-black dark:text-white">Browse files</span></p>
                    </div>
                    <div x-show="isDragging"
                        class="flex items-center justify-center h-full gap-3 py-8 bg-gray-100 dark:bg-gray-800">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                            class="w-4 h-4 text-gray-500 dark:text-gray-400 md:h-6 md:w-6">
                            <path
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400 md:text-base">Drop here to upload</p>
                    </div>
                </div>
            ...
            <div class="flex justify-between w-full mt-2">
                <div class="flex gap-3 text-xs text-gray-500 md:text-sm">
                    @php
                ...
                <div x-show="isLoading" class="flex items-center gap-1">
                    <svg aria-hidden="true" width="15" height="15"
                        class="text-gray-200 dark:text-gray-700 dark:fill-gray-200 animate-spin fill-gray-800"
                    ...
                    <div @click="cancelUpload"
                        class="text-xs text-gray-800 underline dark:text-gray-200 hover:cursor-pointer md:text-sm">
                        Cancel upload</div>
                </div>
            </div>
                    ...
                    @foreach ($files as $file)
                        <div
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                @else
                                    <div
                                        class="flex items-center justify-center bg-gray-100 dark:bg-gray-700 h-14 w-14">
                                ...
                                <div class="flex flex-col items-start gap-1">
                                    <div
                                        class="text-xs font-medium text-center dark:text-slate-100 text-slate-900 md:text-sm">
                                        {{ $file['name'] }}</div>
                                    <div class="text-xs font-medium text-center text-gray-500 md:text-sm">
