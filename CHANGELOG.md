...
### Fixed
- **Logout Redirect**: Default redirect after logout updated to `website.home` to match standard route configuration and prevent missing route errors when `manta.user_home` is not set.
